...
# Contact: ben.kooijman@molnbolaget.com
# Description:
...
# Revisions:
#   - 2021-07-06: Initial completion of script
#   - 2021-10-12: Add support for Find-GapsInVnet function
#   - 2021-10-26: Bug fix where allocatedNetworks overlapped if mask differed in gap detection
...
if ($(Get-AzContext).Subscription -ne "") {
    ...
    $lastAllocatedNetwork, $lastAllocatedCidr = @($vnetObj.Subnets | ForEach-Object { $_.AddressPrefix } | Sort-Object -Descending)[0].split("/")
